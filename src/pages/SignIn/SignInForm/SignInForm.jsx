        ...
        <div className='mb-16'>
            <div className="lg:min-h-[calc(100vh-450px)] flex items-center justify-center">
                <form onSubmit={handleLogin} className="lg:w-fit min-h-[400px] mt-10 bg-[#EDEEF7] text-center px-10 py-6 rounded-[30px] ">
                    ...
                    <button className="btn bg-[#6658C5] capitalize text-white rounded-full gap-4 w-full mt-6 py-3 shadow-none font-medium font-['__gellix_0bf537, __gellix_Fallback_0bf537'] hover:bg-[#4936c3]">
