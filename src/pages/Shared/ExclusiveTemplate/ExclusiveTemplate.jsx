            ...
            <div className="translate-y-10 opacity-0 templateScrollTrigger"
                ...
                <Link to={`/exclusive/${_id}`}>
                    ...
                    <div className="flex items-center justify-between px-5 py-4 font-raleway relative">
                        ...
                        <p className="absolute top-0 right-0 font-bold font-raleway text-white px-3 py-1 bg-[#4864EC] 3xl:text-[14px] 2xl:text-[12px] desktop:text-[11px] laptop:text-[11px] tablet:text-[11px] text-[10px] 3xl:mt-4 2xl:mt-4 desktop:mt-4 laptop:mt-4 tablet:mt-4 mt-4">
                            ${price}
                        </p>
                    </div>
...
export default ExclusiveTemplate;