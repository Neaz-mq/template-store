...
const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-[#EDEEF7] relative">
            ...
            <div className="footer p-10 text-base-content relative">
                ...
                <div className="flex flex-wrap justify-between lg:gap-24 gap-4 ">
                    <nav className="flex text-[#564e77] flex-col flex-wrap text-base font-['__gellix_0bf537, __gellix_Fallback_0bf537'] lg:ml-32 lg:-mr-5 font-semibold gap-4">
                        <Link to="flyers" className="link link-hover">Flyers</Link>
                        <Link to="brochures" className="link link-hover">Brochures</Link>
                        <Link to="branding" className="link link-hover">Logo and Branding</Link>
                    </nav>
                    ...
                    <nav className="flex text-[#564e77] flex-col flex-wrap text-base font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-semibold gap-4 lg:ml-6">
                        <Link to="support" className="link link-hover">Customer Support</Link>
            ...
            {/* Copyright Section */}
            <div className="text-center border-t-2 lg:ml-12 lg:mr-44 ml-10 mr-10" id="footer">
