            ...
            <div className="translate-y-10 opacity-0 templateScrollTrigger"
                ...
                <Link to={`/template/${_id}`}>
                    ...
                    <div className="flex items-center justify-between px-5 py-4">
                        ...
                        <p className="font-bold font-roboto text-[#2F1C6A] px-3 py-1 rounded-md 3xl:text-[14px] 2xl:text-[12px] desktop:text-[10px] laptop:text-[8px] bg-[#EDEEF7] 3xl:ml-7 3xl:-mr-5 2xl:ml-7 2xl:-mr-5 ml-7 desktop:ml-7 desktop:-mr-5 laptop:ml-7 laptop:-mr-5 -mr-5">$ {price}</p>
                    </div>
