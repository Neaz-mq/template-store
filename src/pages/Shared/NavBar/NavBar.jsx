const NavBar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <a className="hover:text-[#7673E5]">Template</a> 
      <a className="hover:text-[#7673E5]">Company</a>
      <a className="hover:text-[#7673E5]">Contact Us</a>
...
<div className="navbar-end gap-3 lg:gap-0">
  ...
  <button className="btn  btn-sm hover:bg-[#7666E3] bg-[#6658C5] font-['__gellix_0bf537, __gellix_Fallback_0bf537'] capitalize text-white rounded-full gap-4 px-6 py-4 lg:mr-20 lg:-ml-9"><span className="-mt-2">Sign up</span></button>
  </div>
</div>
</div>
