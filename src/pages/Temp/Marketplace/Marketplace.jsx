        ...
        <div>
          <div className="layout rounded-[30px] bg-[#7666E3] flex justify-between lg:mx-20 mx-3 lg:mb-20 mb-10 lg:mt-24 mt-16">
            <div className="p-10 lg:pl-14">
                <h2 className="text-xl mt-4 md:text-2xl lg:text-3xl text-white font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium">First Marketplace, <br/> where client choose best design</h2>
                <br/>
                <br/>
