                ...
                <div className="max-w-[700px] lg:h-[780px] mx-auto px-4 flex flex-col items-center justify-center gap-4 ">
                    ...
                    <div className="flex gap-5 items-center pb-16 pt-3 ">
                        ...
                        <ul className="flex flex-wrap gap-2">
                            <li className={`text-sm font-roboto font-bold  text-gray-600 border border-black/50 rounded-full px-4 pt-1 pb-2 hover:text-[#7b75f1] duration-100 cursor-pointer ${selectedCategory.includes('agency') ? 'text-[#7b75f1]' : ''}`} onClick={() => handleCategoryClick(['agency'])}>Agency</li>
                            <li className={`text-sm font-roboto font-bold  text-gray-600 border border-black/50 rounded-full px-4 pt-1 pb-2 hover:text-[#7b75f1] duration-100 cursor-pointer ${selectedCategory.includes('ecommerce') ? 'text-[#7b75f1]' : ''}`} onClick={() => handleCategoryClick(['ecommerce'])}>Ecommerce</li>
                            <li className={`text-sm font-roboto font-bold  text-gray-600 border border-black/50 rounded-full px-4 pt-1 pb-2 hover:text-[#7b75f1] duration-100 cursor-pointer ${selectedCategory.includes('business') ? 'text-[#7b75f1]' : ''}`} onClick={() => handleCategoryClick(['business'])}>Business</li>
                            <li className={`text-sm font-roboto font-bold  text-gray-600 border border-black/50 rounded-full px-4 pt-1 pb-2 hover:text-[#7b75f1] duration-100 cursor-pointer ${selectedCategory.includes('portfolio') ? 'text-[#7b75f1]' : ''}`} onClick={() => handleCategoryClick(['portfolio'])
                            }>Portfolio</li>
                        </ul>
                    </div>
                </div>
