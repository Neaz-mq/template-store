    ...
    return (
        <div className='lg:mx-24 lg:-mt-14 lg:mb-20 overflow-hidden' style={{ overflowX: 'hidden' }}>
                    ...
                    <div className="swiper-wrapper flex gap-8">
...

                        {
                            testimonials.map(testimonial =>
                                <div className="swiper-slide -ml-2 -mr-3"
                                    key={testimonial._id}
                                >
            ...
            <div className="hidden lg:grid grid-cols-3 gap-10 overflow-hidden" data-aos="fade-up" data-aos-duration="700">
                ...
                {
                    testimonials.map(testimonial =>
                        <div className="max-w-[450px] h-[326px] mt-10 bg-white text-slate-800 border border-gray-200 shadow-sm   font-['__gellix_0bf537, __gellix_Fallback_0bf537']  font-medium   rounded-[30px] p-7 relative"
                            key={testimonial._id}
