            ...
            <div className='lg:mx-24 lg:mt-9 lg:mb-14 overflow-hidden'>
                <div className="mb-4 lg:mx-24">
                    <div className="layout mt-10 mb-14 lg:mt-24">
                        <h2 className="text-lg tablet:text-lg laptop:text-lg 3xl:text-2xl 2xl:text-2xl desktop:text-xl text-[#282A37] 3xl:ml-16 2xl:ml-16 desktop:-ml-[5.2rem] font-raleway desktop:-mt-6 laptop:-ml-[5.5rem] tablet:ml-16 tablet:mt-16 ml-14 mt-16">Clients <strong>testimonial</strong></h2>
                    </div>
...

                    {
                        testimonials.map(testimonial =>
                            ...
                            >
                                ...
                                <div className="h-full flex flex-col justify-between">
                                    <p className="text-[13px] mt-10 desktop:mt-10 laptop:mt-0 tablet:mt-0 3xl:mt-5">{testimonial.details}</p>
