                ...
                {activeTab === 'submit' && (
                    <div className="max-w-[940px] mx-auto grid gap-8 lg:gap-0 grid-cols-1 lg:grid-cols-12 place-items-center mt-16" data-aos="fade-up" data-aos-duration="700">
                        <div className="col-span-2 text-center flex flex-col items-center">
                            ...
                            <p className="font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium text-slate-900 mt-8">Submit Your Template</p>
                        </div>
                        <img alt="Roadmap" loading="lazy" width="385" height="25" decoding="async" data-nimg="1" className="hidden lg:block col-span-3 -mt-10" src="https://prographr.vercel.app/_next/static/media/road.b10c4628.svg" style={{ color: 'transparent' }} />
                        <div className="col-span-2 text-center flex flex-col items-center">
                            <div className="relative">
                            ...
                            <p className="font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium text-slate-900 mt-8 w-[210px]">Template Submitted</p>
                        </div>
                        <img alt="Roadmap" loading="lazy" width="385" height="25" decoding="async" data-nimg="1" className="hidden lg:block col-span-3 -mt-10" src="https://prographr.vercel.app/_next/static/media/road.b10c4628.svg" style={{ color: 'transparent' }} />
                        <div className="col-span-2 text-center flex flex-col items-center">
                            <div className="relative">
                                <div className="false">
                                    <div className="hidden"></div>
                                    <img alt="Template" loading="lazy" width="150" height="167" decoding="async" data-nimg="1" className="relative z-10 w-[120px] h-[120px] bg-[#ECEDF6] object-contain p-2 rounded-full" src="https://prographr.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fslider.2aa6a74b.png&w=256&q=75" style={{ color: 'transparent' }} />
                                    <span className="absolute z-20 -bottom-2 text-[10px] -right-2 text-white bg-[#7666E3] rounded-full py-4 px-3">REVIEW</span>
                                </div>
                            </div>
                            <p className="font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium text-slate-900 mt-8 w-[210px]">Template Under Review</p>
                        </div>
                    </div>
                )}
                {activeTab === 'approved' && (
                    <div className="max-w-[940px] mx-auto grid gap-8 lg:gap-0 grid-cols-1 lg:grid-cols-12 place-items-center mt-16" data-aos="fade-up" data-aos-duration="700">
                        <div className="col-span-2 text-center flex flex-col items-center">
                            ...
                            <p className="font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium text-slate-900 mt-8">Template Approved</p>
                        </div>
                        <img alt="Roadmap" loading="lazy" width="385" height="25" decoding="async" data-nimg="1" className="hidden lg:block col-span-3 -mt-10" src="https://prographr.vercel.app/_next/static/media/road.b10c4628.svg" style={{ color: 'transparent' }} />
                        <div className="col-span-2 text-center flex flex-col items-center">
                            <div className="relative">
                            ...
                            <p className="font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium text-slate-900 mt-8 w-[210px]">Your Template is Approved</p>
                        </div>
                        <img alt="Roadmap" loading="lazy" width="385" height="25" decoding="async" data-nimg="1" className="hidden lg:block col-span-3 -mt-10" src="https://prographr.vercel.app/_next/static/media/road.b10c4628.svg" style={{ color: 'transparent' }} />
                        <div className="col-span-2 text-center flex flex-col items-center">
                            <div className="relative">
                                <div className="false">
                                    <div className="hidden"></div>
                                    <img alt="Template" loading="lazy" width="150" height="167" decoding="async" data-nimg="1" className="relative z-10 w-[120px] h-[120px] bg-[#ECEDF6] object-contain p-2 rounded-full" src="https://prographr.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fslider.2aa6a74b.png&w=256&q=75" style={{ color: 'transparent' }} />
                                    <span className="absolute z-20 -bottom-2 text-[10px] -right-2 text-white bg-[#7666E3] rounded-full py-4 px-3">LIVE</span>
                                </div>
                            </div>
                            <p className="font-['__gellix_0bf537, __gellix_Fallback_0bf537'] font-medium text-slate-900 mt-8 w-[210px]">Your Template is Live</p>
                        </div>
                    </div>
                )}
            </div>
