        ...
        <div className="container mx-auto">
            <div className="layout lg:py-20 py-14 mt-24 lg:mx-20">
                <header className="flex items-center justify-between mb-10">
                    <h2 className="lg:text-4xl text-lg tablet:text-xl  text-[#2F1C6A] ml-3 lg:ml-4 font-medium font-roboto 3xl:ml-[10rem] 2xl:ml-[10rem] desktop:ml-[1rem]">Top Selling <strong>Graphics Templates</strong></h2>
