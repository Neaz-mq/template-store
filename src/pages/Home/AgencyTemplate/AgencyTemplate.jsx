    ...
    <div className="container mx-auto font-raleway">
      <div className="layout lg:py-2 py-14 mt-0 lg:mx-20">
        ...
        >
          {displayedTemplates.map((item) => (
            <TemplateItem key={item._id} item={item} />
          ))}
        </section>
      </div>
      ...
      <div className="flex justify-center">
        <div className="mt-16 mb-10 lg:mb-0">
          <button
            className="btn font-raleway mr-2 lg:mr-4 text-[#4864EC] bg-transparent capitalize hover:bg-[#F9F9F9] font-semibold gap-4 shadow-none pt-1 pl-4 border-blue-700  rounded-none"
            onClick={handleViewMore}
          >
            <span className="-mt-1">
              {showAll ? "Show Less" : "View More Top Selling Items"}
            </span>
          </button>
        </div>
      </div>
