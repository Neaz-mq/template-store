...
const Banner = () => {
  ...
  return (
    ...
    <section className="w-full bg-[#ffffff] font-raleway 3xl:pb-[7rem] 2xl:pb-[7rem] desktop:pb-[7rem] laptop:pb-[7rem] pt-6 3xl:-mt-4 2xl:-mt-4 desktop:-mt-5 -mt-24 laptop:-mt-4 tablet:-mt-24 ">
