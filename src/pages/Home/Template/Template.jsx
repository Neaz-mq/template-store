                ...
                <div className="bg-[#ffffff] container mx-auto">
                    <div className="flex">
                        <div className="flex 3xl:ml-24 2xl:ml-28 desktop:ml-[5.2rem] tablet:ml-[18.3rem] laptop:ml-24 ml-16">
                            <div>
                                <h1 className="3xl:text-3xl 2xl:text-2xl desktop:text-2xl laptop:text-2xl text-xl font-semibold text-left leading-[2.5rem] text-[#4864EC] font-raleway 3xl:-mt-44 2xl:-mt-44 desktop:-mt-44 laptop:-mt-44 hidden 3xl:block 2xl:block desktop:block laptop:block">
                                    Explore <br /> <span className="italic">our work</span>
                                </h1>
                                <h1 className="text-[#4864EC] 3xl:hidden 2xl:hidden desktop:hidden laptop:hidden block tablet:text-2xl text-lg font-raleway font-semibold tablet:mt-10 mt-20 ml-3    tablet:-ml-16">
                                    Explore our work
                                </h1>
                    ...
                    <div className="bg-[#4864EC] h-[20rem] 3xl:h-[16rem] 2xl:h-[16rem] desktop:h-[15rem] laptop:h-[14.5rem] tablet:h-[13rem] w-fit 3xl:w-screen 2xl:w-screen desktop:w-screen laptop:w-screen tablet:w-fit overflow-hidden tablet:overflow-hidden  3xl:-mt-60 3xl:ml-[36rem] 2xl:-mt-64 2xl:ml-[36rem] desktop:-mt-60 laptop:-mt-60 tablet:mt-14 mt-10 desktop:ml-[30rem] laptop:ml-[22rem]  ml-10 ">
                            ...
                            <section className="text-white">
                                <div className="flex justify-start items-start flex-col 3xl:flex-row 2xl:flex-row desktop:flex-row laptop:flex-row tablet:flex-row gap-2  3xl:gap-32 2xl:gap-28 desktop:gap-20 laptop:gap-10  tablet:gap-6 px-5 mt-6 3xl:ml-36 3xl:mt-7 2xl:ml-28 desktop:ml-12 laptop:ml-16 tablet:-ml-6 ml-2">
                                    <div className="text-center hidden">
                                        ...
                                        <p className="text-[16px] text-white mt-5 ml-3 hidden 3xl:block 2xl:block desktop:block laptop:block">
                                            Template <br /> <span className="ml-6">sold till now</span>
                                        </p>
                                        <p className="text-base text-white mt-5 block 3xl:hidden 2xl:hidden desktop:hidden laptop:hidden">
                                    ...
                                    <div className="text-center ml-4">
                                        ...
                                        <p className="text-[16px] text-white mt-5 ml-3 mr-12 hidden 3xl:block 2xl:block desktop:block laptop:block">
                                            Premium <br /> <span className="ml-2">Templates</span>
                                        </p>
                                        <p className="text-base text-white mt-5 block 3xl:hidden 2xl:hidden desktop:hidden laptop:hidden -ml-3 tablet:-ml-0">
                                            Premium Templates
                                        </p>
                                    </div>
                                    ...
                                    <div className="ml-16">
                                        ...
                                        <p className="text-base text-white mt-5 block 3xl:hidden 2xl:hidden desktop:hidden laptop:hidden -ml-10 tablet:-ml-0">
                                        Free Templates
                                        </p>
                                    </div>
                                </div>
