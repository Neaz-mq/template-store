                ...
                <div className="bg-[#ffffff] container mx-auto">
                    <div className="flex">
                        <div className="flex 3xl:ml-60 2xl:ml-60 desktop:ml-24 tablet:ml-[18.3rem] laptop:ml-24 ml-16">
                            <div>
                                <h1 className="3xl:text-3xl 2xl:text-2xl desktop:text-xl laptop:text-xl text-xl font-semibold text-left leading-[2.5rem] text-[#4864EC] font-raleway 3xl:-mt-44 2xl:-mt-44 desktop:-mt-44 laptop:-mt-44 hidden 3xl:block 2xl:block desktop:block laptop:block">
                                    Explore <br /> <span className="italic">our work</span>
                                </h1>
                                <h1 className="text-[#4864EC] 3xl:hidden 2xl:hidden desktop:hidden laptop:hidden block tablet:text-2xl text-lg font-raleway font-semibold tablet:mt-16 mt-20 -ml-1    tablet:-ml-6">
                                    Explore our work
                                </h1>
                    ...
                    <div className="bg-[#4864EC] h-[20rem] 3xl:h-[16rem] 2xl:h-[16rem] desktop:h-[15rem] laptop:h-[14.5rem] tablet:h-[13rem] w-fit 3xl:w-screen 2xl:w-screen desktop:w-screen laptop:w-screen overflow-hidden tablet:overflow-hidden container mx-auto 3xl:-mt-60 3xl:ml-[36rem] 2xl:-mt-64 2xl:ml-[36rem] desktop:-mt-60 laptop:-mt-60 tablet:mt-14 mt-10 desktop:ml-[30rem] laptop:ml-[22rem] tablet:ml-[0.5rem] ml-3">
                            ...
                            <section className="text-white">
                                <div className="flex justify-start items-start flex-col 3xl:flex-row 2xl:flex-row desktop:flex-row laptop:flex-row tablet:flex-row gap-2 lg:gap-16 3xl:gap-28 2xl:gap-24 desktop:gap-20 tablet:gap-16 px-5 mt-6 3xl:ml-24 3xl:mt-7 2xl:ml-20 desktop:ml-8 laptop:ml-0 tablet:ml-6 ml-2">
                                    ...
                                    <div className="text-center ml-4">
                                        <h1 className="3xl:text-4xl 2xl:text-4xl desktop:text-3xl laptop:text-3xl tablet:text-2xl text-xl font-bold  3xl:mt-12 2xl:mt-14 desktop:mt-10 laptop:mt-8 tablet:mt-8 mt-2 -ml-9" aria-label="Premium templates">
