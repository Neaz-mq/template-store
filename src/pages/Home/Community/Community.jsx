const Community = () => {
    return (
        <div className='container mx-auto overflow-x-hidden tablet:overflow-x-hidden 2xl:overflow-x-hidden 3xl:overflow-x-hidden desktop:overflow-x-hidden laptop:overflow-x-hidden font-raleway overflow-hidden'>
            <div className='mx-3'>
