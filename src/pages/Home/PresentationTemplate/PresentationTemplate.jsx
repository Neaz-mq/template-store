    ...
    return (
      <div className="bg-[#4864EC] h-[14.5rem] w-auto mt-28 overflow-hidden font-raleway">
        <div className="container mx-auto">
          <div className="relative flex flex-col 3xl:flex-row 2xl:flex-row desktop:flex-row laptop:flex-row tablet:flex-row items-center justify-start 3xl:ml-[15.8rem] 2xl:ml-[15rem] desktop:ml-[6.2rem] laptop:ml-[6.2rem] tablet:ml-[0.2rem]">
            {/* Text Section */}
            <div>
