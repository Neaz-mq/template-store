             ...
             2xl:-mt-36 desktop:-mt-44 laptop:-mt-36 tablet:-mt-16">
                <div className="layout lg:py-8 py-14 mt-24 lg:mx-20">
                    <header className="flex items-center justify-between mb-10">
                        <h1 className="text-lg tablet:text-lg laptop:text-lg 3xl:text-2xl 2xl:text-2xl desktop:text-xl text-[#282A37] ml-3  font-raleway 3xl:ml-[1rem] 2xl:ml-[1.2rem] desktop:ml-[0.2rem] font-medium">
                            Free <strong>Templates</strong>
                        </h1>
                    </header>
                    <main className="layout lg:-mt-10 py-12 -mt-16 lg:mx-20">
                        <div className="grid grid-cols-1 mx-4 md:grid-cols-2 laptop:grid-cols-2 3xl:grid-cols-4 2xl:grid-cols-4 desktop:grid-cols-4 gap-x-4 gap-y-6 3xl:-ml-[4rem] 3xl:mr-16 3xl:gap-x-6 3xl:gap-y-8 2xl:-ml-[3.8rem] 2xl:mr-24 2xl:gap-x-4 2xl:gap-y-8 desktop:-ml-[4.8rem]   desktop:-mr-16 laptop:-ml-[4.1rem] laptop:-mr-16"
                            data-aos="fade-up"
