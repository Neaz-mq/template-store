                            ...
                            <div className="flex flex-col lg:flex-row w-full gap-16"> {/* Added gap-8 for space between sections */}
                                ...
                                <div className="w-full lg:w-1/2">
                                    <img 
                                        ...
                                        alt={`Offer ${index + 1}`} 
                                        className="3xl:w-[39.5rem] 3xl:h-[50rem] 2xl:w-[39.5rem] 2xl:h-[50rem] desktop:w-[39.5rem] desktop:h-[50rem] laptop:w-[39.5rem] laptop:h-[50rem] object-cover 3xl:ml-20 2xl:ml-20 tablet:ml-28 laptop:-ml-16 3xl:-mt-0 2xl:-mt-0 desktop:-mt-0 laptop:-mt-0 tablet:-mt-10 tablet:pb-20 3xl:pb-0 2xl:pb-0 desktop:pb-0 laptop:pb-0 -mt-14 pb-20 w-[30rem] h-[30rem] " 
                                    />
                                </div>
                            </div>
                        </div>
