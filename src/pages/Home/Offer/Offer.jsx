...
const Offer = () => {
    ...
    return (
        <div className="pb-0 tablet:pt-12 3xl:-mt-4 2xl:-mt-4 desktop:pt-0 laptop:pt-0 pt-10 ">
            {offers.length > 0 &&
                        ...
                        <div className="container mx-auto px-4 overflow-x-hidden">
                            <div className="flex flex-col lg:flex-row w-full gap-16"> {/* Added gap-8 for space between sections */}
                                ...
                                <div className="w-full 3xl:w-[40rem] 2xl:w-[40rem] desktop:w-[30rem] laptop:w-[30rem] p-4 flex flex-col items-center justify-center lg:justify-start">
                                    <h1
                                        className="3xl:text-6xl 2xl:text-6xl desktop:text-4xl laptop:text-base text-lg tablet:text-xl 3xl:ml-[13.8rem] 3xl:-mr-8 2xl:ml-[13.8rem] 2xl:-mr-8 desktop:ml-[5rem] desktop:-mr-8 laptop:ml-[6rem] laptop:-mr-2 text-[#282A37] font-extrabold lg:font-bold 3xl:leading-[70px] 2xl:leading-[70px] desktop:leading-[50px] laptop:leading-[40px] tablet:leading-[60px] text-center lg:text-start 3xl:mt-[11rem] 2xl:mt-[10rem] desktop:mt-[12rem] laptop:mt-[12rem] mb-3 font-raleway tablet:mt-16 mt-14"
                                ...
                                <div className="w-full lg:w-1/2">
                                    <img
                                        ...
                                        alt={`Offer ${index + 1}`}
                                        className="3xl:w-[40.2rem] 3xl:h-[50rem] 2xl:w-[36rem] 2xl:h-[48rem] desktop:w-[38rem] desktop:h-[48rem] laptop:w-[38rem] laptop:h-[48rem] object-cover 3xl:ml-20 2xl:-ml-8 desktop:ml-1 tablet:ml-32 laptop:-ml-14 3xl:-mt-0 2xl:-mt-0 desktop:-mt-0 laptop:-mt-0 tablet:-mt-10 tablet:pb-20 3xl:pb-0 2xl:pb-0 desktop:pb-0 laptop:pb-0 -mt-14 pb-20 w-[30rem] h-[30rem] "
                                    />
                                </div>
                            </div>
                        </div>
