  ...
  return (
    <div className="font-raleway">
      <div className="container mx-auto overflow-x-hidden 2xl:overflow-x-hidden 3xl:overflow-x-hidden desktop:overflow-x-hidden laptop:overflow-x-hidden">
        <header>
          <h1 className="text-lg tablet:text-lg laptop:text-lg 3xl:text-2xl 2xl:text-2xl desktop:text-xl  2xl:mt-28  3xl:mt-32 3xl:ml-[6.4rem] 2xl:ml-[6.4rem] 3xl:mb-12 desktop:ml-[5.2rem] laptop:mt-28 desktop:mt-32 tablet:mt-24 tablet:mb-6 mt-16 ml-8 mb-4 text-[#282A37] font-raleway laptop:ml-20 laptop:mb-4 tablet:ml-14">
            What makes us <strong> better</strong>
          </h1>
        </header>
        <main className="-ml-1 tablet:ml-14 tablet:mr-0 grid place-items-center desktop:gap-6 tablet:grid-cols-2 laptop:grid-cols-3 gap-4 tablet:gap-2 laptop:gap-2 2xl:gap-0 3xl:gap-0 3xl:ml-8 2xl:-mr-4 2xl:ml-9 3xl:-mr-6 desktop:-mr-9 desktop:ml-[4.2rem] laptop:mr-10 laptop:ml-4 mt-10 2xl:mt-12 desktop:mt-12 laptop:mt-12 ">
          <section className="w-full flex justify-center 3xl:mr-10 3xl:-ml-20 2xl:mr-10 2xl:-ml-20 desktop:mr-16 desktop:-ml-16">
            <article className="bg-[#F9F9F9] desktop:max-w-[380px] laptop:h-[250px] 2xl:max-w-[350px] desktop:h-[290px] laptop:max-w-[270px] tablet:max-w-[350px] tablet:h-[280px] max-w-[320px] h-[260px]  p-6  3xl:max-w-[380px] 3xl:h-[290px] 3xl:ml-[7rem] 3xl:mr-4 3xl:mb-12 2xl:ml-[7rem] 2xl:mr-0 2xl:mb-12 desktop:ml-20 laptop:ml-16 desktop:mr-0 desktop:mb-12 font-raleway ">
              <div className="flex items-center justify-between">
                ...
                <div className="w-[60px]  h-[60px] laptop:hidden 3xl:block 2xl:block desktop:block tablet:block overflow-hidden bg-[#282A37] text-white flex items-center justify-center text-2xl">
                  <img
          ...
          <section className="w-full flex justify-center 3xl:mr-72 2xl:mr-72 desktop:mr-44">
            <article className="bg-[#F9F9F9] desktop:max-w-[380px] 2xl:max-w-[330px] laptop:max-w-[270px] desktop:h-[290px] laptop:h-[250px] tablet:max-w-[340px] tablet:h-[280px] max-w-[320px] h-[260px]  p-6  desktop:mr-20 3xl:max-w-[400px] 3xl:mr-28 desktop:mb-12 3xl:mb-12 2xl:mr-28 2xl:mb-12 laptop:mr-10 font-raleway ">
              <div className="flex items-center justify-between">
                ...
                <div className="w-[60px] h-[60px] laptop:hidden  overflow-hidden bg-[#282A37] text-white flex items-center justify-center text-2xl laptop:ml-2 3xl:block 2xl:block desktop:block tablet:block ml-1">
                  <img
                    className="lazy-load decoration-transparent scale-125 3xl:mt-0 3xl:ml-0 2xl:mt-1 2xl:ml-0 desktop:mt-0 desktop:ml-0 laptop:mt-6 laptop:ml-5 tablet:mt-0 tablet:ml-0"
