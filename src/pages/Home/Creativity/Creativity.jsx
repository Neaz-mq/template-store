    ...
    return (
        <div className="layout font-roboto" >
            <div className="container mx-auto 2xl:overflow-x-hidden 3xl:overflow-x-hidden" >
                <header>
                    <h1 className="text-3xl laptop:text-3xl 3xl:text-3xl 2xl:mt-12 2xl:text-3xl 3xl:mt-12 laptop:-mt-14 -mt-28 text-[#2F1C6A] text-center laptop:mb-4">
                        What <strong>makes us better</strong>
                    </h1>
                </header>

                <main className="py-6 ml-4 mr-3 grid place-items-center desktop:gap-0 tablet:grid-cols-2 laptop:grid-cols-3 gap-4 tablet:gap-6 laptop:gap-0 2xl:gap-0 3xl:gap-0 3xl:ml-48 2xl:-mr-6 2xl:ml-48 3xl:-mr-6 desktop:-mr-9 desktop:ml-20 laptop:mr-10 laptop:ml-9">
                    ...
                    <section className="w-full flex justify-center 3xl:mr-72 2xl:mr-72 desktop:mr-36 ">
                        <article className="bg-[#EDEEF7] desktop:max-w-[340px] 2xl:max-w-[300px] laptop:max-w-[245px] desktop:h-[290px] laptop:h-[380px] p-6 rounded-[30px] desktop:mr-28 3xl:max-w-[400px] 3xl:mr-28 desktop:mb-12 3xl:mb-12 2xl:mr-28   2xl:mb-12 laptop:mr-10">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-[80px] h-[80px] laptop:hidden rounded-full overflow-hidden bg-primary text-white flex items-center justify-center text-2xl laptop:ml-2 3xl:block 2xl:block desktop:block tablet:block">
                                    <img
                                        className="decoration-transparent scale-125"
