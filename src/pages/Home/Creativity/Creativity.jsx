            ...
            <main className="py-10 grid place-items-center gap-4 lg:grid-cols-3" data-aos="fade-up" data-aos-duration="700">
                <section className="translate-y-24 opacity-0 gsapTrigger" style={{ transform: 'translateY(0px)', opacity: 1 }}>
                    <article className="bg-[#EDEEF7] max-w-[380px] min-h-[312px] p-6 rounded-[30px]">
                        ...
                        <a href="#" title="Learn more about our creativity">
                            <button className="btn bg-white hover:bg-gray-100 font-medium capitalize text-[#4a465b] rounded-full gap-4">
                ...
                <section className="translate-y-24 opacity-0 gsapTrigger" style={{ transform: 'translateY(0px)', opacity: 1 }}>
                    <article className="bg-[#EDEEF7] max-w-[380px] min-h-[312px] p-6 rounded-[30px]">
                        ...
                        <a href="#" title="Learn more about our team collaboration">
                ...
                <section className="translate-y-24 opacity-0 gsapTrigger" style={{ transform: 'translateY(0px)', opacity: 1 }}>
                    <article className="bg-[#EDEEF7] max-w-[380px] min-h-[312px] p-6 rounded-[30px]">
                        ...
                        <a href="#" title="Learn more about our professionalism">
                            <button className="btn bg-white hover:bg-gray-100 font-medium capitalize text-[#4a465b] rounded-full gap-4 mt-5">
                                <span className="-mt-1">Learn More</span>
                                <svg stroke="currentColor" fill="none" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="7" y1="17" x2="17" y2="7"></line>
