...
const Exclusive = () => {
    ...
    return (
        <div className="bg-[#ffffff] font-raleway">
            <div className="container mx-auto 3xl:pt-5 2xl:pt-5 desktop:pt-5 laptop:pt-5 tablet:pt-5 pt-0 -mt-2 3xl:-mt-0 2xl:-mt-0 desktop:-mt-0 laptop:-mt-0 tablet:-mt-0">
                <div className="layout lg:py-8 py-14 mt-24 lg:mx-20">
                    <header className="flex items-center justify-between mb-10">
                        ...
                        <button
                            ...
                            className="mr-2 3xl:mr-[8.2rem] 2xl:mr-44 desktop:mr-4 font-raleway text-[#6e6d7a] capitalize font-semibold gap-4 p-3 pl-4 flex items-center">
