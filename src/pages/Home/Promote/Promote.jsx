    ...
    <div className="bg-[#4864EC] h-[14.5rem] w-auto 3xl:-mt-60 2xl:-mt-14 desktop:-mt-14 laptop:-mt-14 tablet:-mt-14 -mt-32 overflow-hidden font-raleway">
      <div className="container mx-auto">
        <div className="relative flex flex-col 3xl:flex-row 2xl:flex-row desktop:flex-row laptop:flex-row tablet:flex-row items-center justify-start 3xl:ml-[6rem] 2xl:ml-[6.7rem] desktop:ml-[5rem] laptop:ml-[6rem] tablet:ml-[2.3rem]">
          <div>
            <h1 className="3xl:text-3xl 2xl:text-3xl desktop:text-3xl laptop:text-2xl text-2xl font-semibold text-left 3xl:leading-[2.8rem] 2xl:leading-[2.8rem] desktop:leading-[2.8rem] laptop:leading-[2.8rem] leading-[2.2rem] text-white font-raleway 3xl:-mt-20 2xl:-mt-12 desktop:-mt-2 laptop:mt-8 tablet:mt-16 mt-6 ml-4">
          ...
          <a className="3xl:-mt-24 2xl:-mt-16 desktop:-mt-2 laptop:mt-6 tablet:mt-14 relative z-10" href="/template">
            <button className="bg-white text-[#282A37] 3xl:py-3 3xl:px-10 2xl:py-3 2xl:px-10 desktop:py-3 desktop:px-10 laptop:py-3 laptop:px-10 tablet:py-2 tablet:px-8 py-2 px-6 font-bold 3xl:-ml-[46rem] 2xl:-ml-[42rem] desktop:-ml-[33rem] laptop:-ml-[30rem] tablet:ml-44 mt-6 whitespace-nowrap">
