           ...
           <div className="layout min-h-[calc(100vh-500px)] flex items-center my-16">
            <div className="w-fit mx-auto flex flex-col items-center">
                ...
                <div className="flex gap-4 mt-10"><a href="/sign-up">
                    ...
                    <a href="/sign-up-here"><button className="btn bg-[#6658C5] font-medium font-['__gellix_0bf537, __gellix_Fallback_0bf537'] hover:bg-[#4936c3]  capitalize text-white rounded-full gap-4 px-10 py-3 text-lg"><span className="-mt-1">Buyer</span></button></a></div>
                    </div>
                    </div>
        </div>
    );
