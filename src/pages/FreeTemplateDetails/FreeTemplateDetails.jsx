    ...
    return (
        ...
        <div>
            ...
            <Helmet>
                ...
                <link rel="canonical" href="https://www.prographr.com/free" />
            </Helmet>
            ...
            <div className="lg:ml-20 mb-16">
                <div className="mt-14 flex lg:flex-row flex-col gap-6 ml-2">
                    ...
                    <div className="flex flex-col items-center mt-12" style={{ width: "60%" }}>
                        <div className={`border ${selectedTemplate === 'templateCustom' ? 'border-primary' : 'border-gray-400'} rounded-[20px] p-8 lg:w-[85%] lg:h-[30%] w-[160%] h-[100%] lg:-ml-14 lg:mr-9 ml-40  cursor-pointer`} onClick={() => handleTemplateChange('templateCustom')}>
