        ...
        <>
            ...
            <div className="lg:min-h-[calc(100vh-450px)] flex items-center justify-center mb-20 mt-4">
                <form onSubmit={handleSubmit(onSubmit)} className="lg:w-[450px] w-80 min-h-[400px] bg-[#EDEEF7] text-center px-10 py-6 rounded-[30px] mt-10 lg:-ml-0">
                    <h3 className="text-xl font-medium font-raleway text-slate-800 mb-6">Sign Up</h3>
                    ...
                    <div className="form-control py-3"><label className="flex gap-3">
                        <input className="checkbox checkbox-primary" type="checkbox" /><span className="label-text font-medium font-raleway text-slate-800">I agree with all the <a href="#" className="text-blue-500 underline">terms and services</a></span></label>
                    </div>
                    <div className="form-control -mt-5">
                        <button className="btn bg-[#6658C5]  font-medium font-raleway hover:bg-[#4936c3] capitalize text-white rounded-full gap-4 w-full mt-5 py-3 shadow-none" type="submit"><span className="-mt-1">Sign Up</span><svg stroke="currentColor" fill="none" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></button>
                        <br /> <br />
                        {/* Google Sign-in Button */}
                        <button className="btn btn-google bg-white hover:bg-gray-100 capitalize text-black rounded-full gap-4 w-full -mt-4 py-3 shadow-none font-medium font-raleway">
